...
<thead>
<tr>	
<th><center>id</center></th><th><center>标题</center></th><td>操作</td>
</tr>
</thead>
...
<td><a href="<?php echo U('Article/editByCid/id/'.$vo[id].'/cid/'.$vo[class_id]);?>">编辑</a> |
<a href="<?php echo U('Article/delete/id/'.$vo[id]);?>" onclick='return confirm("确定删除吗？")'>删除</a>
</td>
